...
/* ===== INITIALIZE CASH DRAWER DISPLAY ===== */
...
document.getElementById('purchase-btn').addEventListener('click', function (e) {
  ...
  if (cashInCents === priceInCents) {
    document.getElementById('status').innerText = 'No change due';
  ...
  if (totalCidInCents < changeDueInCents) {
    document.getElementById('status').innerText = 'INSUFFICIENT_FUNDS';
    document.getElementById('change-due').innerText = '';
    return;
  }
  ...
  if (totalCidInCents === cashInCents - priceInCents) {
    ...
    document.getElementById('change-due').innerText = changeArray
